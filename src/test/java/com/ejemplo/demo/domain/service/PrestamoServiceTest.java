...
class PrestamoServiceTest {
    ...
    void debeCalcularSimulacionDePrestamo() {
        ...
        PrestamoResponse response = prestamoService.simularPrestamo(request);
    ...
    void debeFallarCuandoTasaEsMayorACien() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> prestamoService.simularPrestamo(request));
